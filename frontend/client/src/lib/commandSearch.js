...
export const KEYWORDS = {
  ...
  '/people': ['employees', 'roster', 'staff', 'people records', 'employee details', 'users', 'admin', 'access', 'teams'],
  ...
  '/workspace/hiring': ['candidate', 'new joiner', 'recruit', 'approve hire', 'approvals'],
